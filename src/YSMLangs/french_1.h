...
#define MSG_LOGIN_OK		BLUE "Login OK!" NORMAL " << bienvenu á ICQ Résseau >>"
...
#define MSG_STATUS_CHANGE3	NORMAL "a changé sa humeur a:"
...
#define MSG_MESSAGE_SENT1	MAGENTA "YSM Msg Envoyé a escalve appelé" WHITE
#define MSG_MESSAGE_SENT2	MAGENTA "YSM Msg Envoyé a" WHITE
...
#define MSG_AFK_READ_MSG	GREEN "[[ en lisant enregisté Messages ]]" NORMAL
...
#define MSG_ERR_RATE		RED "serveur a dis: Limite de taux dépassée.  Essai encore plus tard." NORMAL
...
#define MSG_ERR_FEATUREDISABLED	"Function  handicapé. Recompile YSM avec Appui De Fils."
...
#define MSG_NEW_OFFLINE		"Message reçu quand tu a été " BRIGHT_BLUE " off line"
...
#define MSG_BUDDY_SAVINGOK	GREEN " [OK] a enregistré un escalve"
