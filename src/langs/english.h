...
#define MSG_STARTING_ONE	"..an" WHITE " Experience" NORMAL " you will never forget.."
...
#define MSG_READ_SLAVES		"YSM Amount of Slaves in db" BRIGHT_BLUE " ["
...
#define MSG_LOGIN_OK		BLUE "Login OK!" NORMAL " << Welcome to the ICQ Network >>"
...
#define MSG_STATUS_CHANGE2	", called" BLUE
#define MSG_STATUS_CHANGE3	NORMAL "changed his mood to:"

#define MSG_STATUS_HIDE1	"[A Slave #"
#define MSG_STATUS_HIDE2	", called" BLUE
#define MSG_STATUS_HIDE3	NORMAL "hides from you in:"

#define MSG_MESSAGE_SENT1	MAGENTA "YSM Msg Sent to Slave called" WHITE
#define MSG_MESSAGE_SENT2	MAGENTA "YSM Msg Sent to" WHITE
...
#define MSG_AFK_MODE_OFF4	"while you were away.\nUse 'readafk' to read or clean the stored messages!.\nLeaving" BRIGHT_BLUE " AFK " NORMAL "mode..\n"

#define MSG_AFK_READ_MSG	GREEN "[[ Reading stored AFK Messages ]]" NORMAL

/* ERROR MESSAGES */

#define MSG_ERR_PASSMATCH	CYAN "<<NO!>>" NORMAL " Passwords do NOT match."
