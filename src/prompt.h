...
void
YSM_ConsoleTabCommand(int32_t argc, int8_t **argv, int32_t *pos, size_t msize);

void
YSM_ConsoleTabSlave(int32_t argc, int8_t **argv, int32_t *pos, size_t msize);

void
YSM_SendMessage( uin_t		r_uin,
		int8_t		*data,
		int8_t		logflag,
		YSM_SLAVE	*slave,
		u_int8_t	verbous );
...
void
YSM_PreOutgoing( YSM_SLAVE	*victim,
		uin_t		r_uin,
		int8_t		**m_data,
		int32_t		*m_len,
		int8_t		logflag );
...
void
YSM_PostOutgoing( uin_t		r_uin,
		int8_t		*r_nick,
		int32_t		m_len,
		int8_t		*m_data );

void
YSM_ExecuteLine( char	*line,
		char	*extra1,
		char	*extra2,
		char	*extra3,
		char	*extra4 );
