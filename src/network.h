...
void YSM_AckOffline(void);
void YSM_SendCliReady(void);
void YSM_RequestICBMRights(void);
void YSM_SendICBM(void);
void YSM_RequestBuddyRights(void);
void YSM_RequestRates(void);
void YSM_IncomingMultiUse(FLAP_Head *head, SNAC_Head *thesnac, char *buf);
void YSM_BuddyIncomingList(FLAP_Head *head, SNAC_Head thesnac, char *buf, int buf_len);
void YSM_BuddyIncomingChange(FLAP_Head *head, SNAC_Head thesnac, char *buf);
void YSM_Incoming_ClientAck(FLAP_Head *flap, SNAC_Head *snac, int8_t *buf); int
YSM_Incoming_SNAC(FLAP_Head *, char *, int);
...
void YSM_ForwardMessage(uin_t _rUIN, char *_msg);
void YSM_IncomingPersonal(FLAP_Head *head, SNAC_Head *thesnac, int8_t *buf);
...
void YSM_BuddyAck(FLAP_Head *, SNAC_Head thesnac, char *buf);
